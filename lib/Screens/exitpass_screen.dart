...
void main() async {
  ...
  runApp(const ExitPassApp());
}

class ExitPassApp extends StatelessWidget {
  const ExitPassApp({super.key});
...
class _ExitPassPageState extends State<ExitPassPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        title: 'Exit Pass', // Title for the Custom AppBar
        onProfilePressed: () {
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child:
              ...
              child: AbsorbPointer(
                child: CustomTextField(
                  label: _selectedExitDate != null
                      ? "Exit Date: ${_selectedExitDate!.toLocal()}"
                          .split(' ')[0]
                      : 'Select Exit Date',
                ),
              ),
            ...
            ElevatedButton(
              onPressed:
                  _submitExitPassRequest, // Call submit function directly
