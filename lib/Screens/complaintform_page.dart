...
import 'package:hms/Screens/header_widget.dart'; // Import HeaderWidget
...
class _ComplaintFormPageState extends State<ComplaintFormPage> {
  ...
  final TextEditingController currentBuildingController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            const HeaderWidget(title: 'Complaint Form'), // Add the HeaderWidget here
            Padding(
                    ...
                    Center(
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: const Color(0xFF33665A), // Set the button color
